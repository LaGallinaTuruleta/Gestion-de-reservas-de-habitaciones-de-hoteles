...
public class Main {
	...
	public static void main(String[] args) {
		...
		hoteles.add(new Hotel("Palace","Calle doritos 13","palace@hotel.com","679666866","*****", 5, 10));
		...
		hoteles.get(0).viewHotel();
		hb.guardarHotelFichero("C:/Users/Blanes-PC/Documents/MEGA/1DAW/PROGRAMACIÓN/3EVALUACION/Hotel/Hotel.txt", hoteles.get(0));
		hoteles.add(hb.insertarHotelFichero("C:/Users/Blanes-PC/Documents/MEGA/1DAW/PROGRAMACIÓN/3EVALUACION/Hotel/Hotel.txt"));
		...
		while (menu == 0) {
			...
			case 1:
				...
				String dirreccion = sc.nextLine();
				String telefono = sc.nextLine();
				String correo = sc.nextLine();
				String estrellas = sc.nextLine();
				int numPlant = sc.nextInt();
				int numHabPlan = sc.nextInt();
				hoteles.add(new Hotel(nombre,dirreccion,correo,telefono,estrellas,numPlant,numHabPlan));
				guardarHotelFichero(null, null);
				break;
			case 2:
